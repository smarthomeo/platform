...
var MessageInputWrapperView = require('../../chunks/bundle-DWxM3ko6.js');
var GroupChannelProvider = require('../../chunks/bundle-Brb0Jg6g.js');
...
var MessageInputWrapper = function (props) {
    var _a = GroupChannelProvider.useGroupChannel(), state = _a.state, actions = _a.actions;
    return React__default.default.createElement(MessageInputWrapperView.MessageInputWrapperView, _tslib.__assign({}, props, state, actions));
};
